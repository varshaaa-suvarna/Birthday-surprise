...
const CONFIG = {
    ...
    memories: {
        ...
        images: [
            { src: "images/mem1.jpeg", caption: "The day it all started" },
            { src: "images/mem2.jpeg", caption: "That road trip" },
            { src: "images/mem3.jpeg", caption: "Way too much laughing" },
            { src: "images/mem4.jpeg", caption: "College chaos" },
            { src: "images/mem5.jpeg", caption: "Best. Day. Ever." },
            { src: "images/mem6.jpeg", caption: "Just us being us" }
        ]
    },
    ...
    letter: {
        ...
        salutation: "WAIT BRO, READ THIS LETTER. I WROTE IT MYSELF, NOT BY AI 😭❤️",

        body:
            `Hello Vaishh brooo ❤️

Every gossip starts with “Entha ayth gotta?” and somehow ends with “Asthena” by your words 😂
...
Always thinking like “hoguva, elligadru hoguva?” But for you, first only one person in my life says “let's go” 😂 I know you will agree only if it is near to Mangaluru 😂
